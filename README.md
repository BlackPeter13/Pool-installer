...
Here you find information all documentation about Yiimpool Installer v2.0  Will mostly automatically install all reequirements to get Yiimp installed correctly. This is a fork of Cryptopool.builders multipool installer, i cant see that the project is active anymore and there for i have start a "Reborn of the project"
